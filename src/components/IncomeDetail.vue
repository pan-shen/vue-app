...
export default {
  ...
  methods: {
    ...
    changeIncomeData () {
      this.data = this.allData.incomeData
      this.addData = this.allData.incomeSeriesAddData
    }
  },
  ready () {
    var yearMonth = this.year + this.month
